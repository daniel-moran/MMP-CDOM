...
### plot blank curves to look for drift - we are only plotting this to eyeball and ensure we are happy with the JCU output at a gross level - they only have start and end blank scans 
...
Samplelvls <- c("MilliQ_start", "MilliQ_end")  
temp2 <- factor(CDOM_blanks$Sample, levels = Samplelvls)
...
```
#convert back to wide format and save a copy of the scans
