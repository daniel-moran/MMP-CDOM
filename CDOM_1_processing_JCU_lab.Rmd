...
temp2 <- factor(CDOM_long$Sample, levels = scan_list)
CDOM_long$Sample <- temp2
rm(temp2)
sapply(CDOM_long, class)
...
#remove the blank scans and replace Sample as JCU lab sample ID with station_name_depth
