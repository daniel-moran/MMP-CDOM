...
copy file path here:
R:\Lagoon_WQ\results\CDOM\2025-26 report\WQR\CDOM-20251015_WQR331-347
---
...
```{r, include=FALSE}
rm(list=ls())
setwd("R:/Lagoon_WQ/results/CDOM/2025-26 report/WQR/CDOM-20251015_WQR331-347")
wd <- getwd()
pwd<- "R:/Lagoon_WQ/results/CDOM/2025-26 report/WQR"
```
