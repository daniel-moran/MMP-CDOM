...
wd <- getwd() #relies on the default working directory based on the location of the script. so users MUST copy the script to the intended wd for the batch that is processing
