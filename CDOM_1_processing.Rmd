...
copy file path here:
R:\Lagoon_WQ\results\CDOM\2024-25 report\JCD\CDOM-20250729_JCD478-488
---
...
```{r, include=FALSE}
rm(list=ls())
setwd("R:/Lagoon_WQ/results/CDOM/2024-25 report/JCD/CDOM-20250729_JCD478-488")
wd <- getwd()
pwd<- "R:/Lagoon_WQ/results/CDOM/2024-25 report/JCD"
```
