...
```{r}
#| label: extract specific wavelegths or variables and analyse
#| eval: true
...
#migrate to Rmd - I have migrated and pushed sections of code into chuncks (7/5/26) but still need to review and make sure they run smoothly
