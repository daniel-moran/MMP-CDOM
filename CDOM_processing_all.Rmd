...
update: 17/08/2026: rewrite and combination of the processing and collation scripts to handle full season of analytical batches for each station family, rather than manually running the script for each batch.
...
```{r, include=FALSE}
rm(list=ls())
setwd("R:/Lagoon_WQ/results/CDOM/2025-26 report/CYA/CDOM-20260121_CYA074-078_&_JCE520-521")
wd <- getwd()
pwd<- "R:/Lagoon_WQ/results/CDOM/2025-26 report/CYA"
```
