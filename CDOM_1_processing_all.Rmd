...
update: 18/08/2026:wrap the processing inside funnctions and adjust the script to run multiple batches at once. intended to run a single family of station only) 
...
#set up the processing function and safe wrapper
```{r, include=FALSE}
...
process_batch <- function(batch_dir){
  ...
  message("")
  message("======================================")
  message("Processing batch: ", basename(batch_dir))
  message("======================================")
  ...
  message("Found ", length(batch_list), " raw data files")
...
safe_process_batch <- function(batch_dir){
  ...
  tryCatch(
    ...
    error = function(e){
      ...
      message("")
      message("***** FAILED *****")
      message("Batch: ", basename(batch_dir))
...
message("")
message("Found ", length(batch_dirs), " batch directories")
...
message("======================================")
message("Successful batches: ", successes)
message("Failed batches: ", failures)
message("======================================")
